                    ...
                    <div class="card-body p-md-5" style="background-color: lightgray">
                        <div class="row justify-content-center">
                            <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                                ...
                                <form action="/reg" method="POST" class="mx-1 mx-md-4">
                                    ...
                                    <div class="d-flex flex-row align-items-center mb-4">
                                        <i class="fas fa-envelope fa-lg me-3 fa-fw"></i>
                                        <div data-mdb-input-init class="form-outline flex-fill mb-0">
                                            <input type="text" name="first_name" id="form3Example3c"
                                                   class="form-control"/>
                                    ...
                                    <div class="d-flex flex-row align-items-center mb-4">
                                        <i class="fas fa-envelope fa-lg me-3 fa-fw"></i>
                                        <div data-mdb-input-init class="form-outline flex-fill mb-0">
                                            <input type="text" name="patronymic" id="form3Example3c"
                                                   class="form-control"/>
                                    ...
                                    <div class="d-flex justify-content-evenly mx-4 mb-3 mb-lg-4">
                                        <button type="submit" data-mdb-button-init data-mdb-ripple-init
                                                class="btn btn-primary btn-lg">Зарегистрироваться
                                        </button>
                                        <a href="/login" data-mdb-button-init data-mdb-ripple-init
                                                class="btn btn-secondary btn-lg">Войти
                                        </a>
                                    </div>
