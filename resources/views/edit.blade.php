                    ...
                    <div class="card-body p-md-5" style="background-color: lightgray">
                        <div class="row justify-content-center">
                            <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                                ...
                                <p class="text-center h1 fw-bold mb-5 mx-1 mx-md-4 mt-4">Изменение информации</p>

                                <form action="/edit/{{$user->id}}" method="POST" class="mx-1 mx-md-4">

                                    <div class="d-flex flex-row align-items-center mb-4">
                                        <i class="fas fa-user fa-lg me-3 fa-fw"></i>
                                        <div data-mdb-input-init class="form-outline flex-fill mb-0">
                                            <input type="text" name="login" id="form3Example1c" class="form-control" value="{{$user->login}}"/>
